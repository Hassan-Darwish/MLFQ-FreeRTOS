 ...
 * ========================================================================== */
    ...
    #define HEAVY_TASK_ONE_ARRIVAL_TIME         500U
    #define HEAVY_TASK_TWO_ARRIVAL_TIME         500U    // Start together to force preemption
    #define INTERACTIVE_TASK_ONE_ARRIVAL_TIME   5000U
    #define INTERACTIVE_TASK_TWO_ARRIVAL_TIME   5000U
    ...
    #define MLFQ_TIME_SLICE_MEDIUM              1500U
    #define MLFQ_TIME_SLICE_LOW                 2500U
    #define MLFQ_BOOST_PERIOD_MS                15000U
